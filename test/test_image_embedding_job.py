...
class TestImageEmbeddingJob(unittest.TestCase):
    """ImageEmbeddingJob unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImageEmbeddingJob:
        """Test ImageEmbeddingJob
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImageEmbeddingJob`
        """
        model = ImageEmbeddingJob()
        if include_optional:
    ...
    def testImageEmbeddingJob(self):
        """Test ImageEmbeddingJob"""

...
class TestQueryJobsResult(unittest.TestCase):
    """QueryJobsResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QueryJobsResult:
        """Test QueryJobsResult
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QueryJobsResult`
        """
        model = QueryJobsResult()
        if include_optional:

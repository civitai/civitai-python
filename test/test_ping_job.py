...
class TestPingJob(unittest.TestCase):
    """PingJob unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PingJob:
        """Test PingJob
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PingJob`
        """
        model = PingJob()
        if include_optional:
            return PingJob(

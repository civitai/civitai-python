...
class TestProviderJobQueuePosition(unittest.TestCase):
    """ProviderJobQueuePosition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProviderJobQueuePosition:
        """Test ProviderJobQueuePosition
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProviderJobQueuePosition`
        """
        model = ProviderJobQueuePosition()
        if include_optional:
            return ProviderJobQueuePosition(
                preceding_jobs = 56,
    ...
    def testProviderJobQueuePosition(self):
        """Test ProviderJobQueuePosition"""

...
class TestWDTaggingJob(unittest.TestCase):
    """WDTaggingJob unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WDTaggingJob:
        """Test WDTaggingJob
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WDTaggingJob`
        """
        model = WDTaggingJob()
        if include_optional:
            return WDTaggingJob(

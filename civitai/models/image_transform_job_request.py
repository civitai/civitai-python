...
class ImageTransformJobRequest(JobRequest):
    ...
    blob_key: Optional[StrictStr] = Field(default=None, description="The key of the blob to transform", alias="blobKey")
    replace: Optional[StrictBool] = Field(default=None, description="Get or set if existing blobs should be replaced. Otherwise the existing blob will be returned")

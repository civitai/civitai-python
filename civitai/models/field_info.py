...
class FieldInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "declaringType", "reflectedType", "module", "customAttributes", "isCollectible", "metadataToken", "memberType", "attributes", "fieldType", "isInitOnly", "isLiteral", "isPinvokeImpl", "isSpecialName", "isStatic", "isAssembly", "isFamily", "isFamilyAndAssembly", "isFamilyOrAssembly", "isPrivate", "isPublic", "isSecurityCritical", "isSecuritySafeCritical", "isSecurityTransparent", "fieldHandle"]

...
JOBTEMPLATELISTJOBSINNER_ONE_OF_SCHEMAS = ["ClearAssetRequest", "ComfyJobRequest", "CopyAssetRequest", "DeleteBlobRequest", "GetBlobRequest", "ImageEmbeddingJobRequest", "ImageResourceTrainingJobRequest", "ImageTransformJobRequest", "MediaTaggingJobRequest", "PinBlobRequest", "PrepareModelJobRequest", "RebootWorkerJobRequest", "TextToImageJobRequest", "UnpinBlobRequest", "UploadBlobRequest", "WDTaggingJobRequest"]
...
class JobTemplateListJobsInner(BaseModel):
    ...
    actual_instance: Optional[Union[ClearAssetRequest, ComfyJobRequest, CopyAssetRequest, DeleteBlobRequest, GetBlobRequest, ImageEmbeddingJobRequest, ImageResourceTrainingJobRequest, ImageTransformJobRequest, MediaTaggingJobRequest, PinBlobRequest, PrepareModelJobRequest, RebootWorkerJobRequest, TextToImageJobRequest, UnpinBlobRequest, UploadBlobRequest, WDTaggingJobRequest]] = None
    one_of_schemas: Set[str] = { "ClearAssetRequest", "ComfyJobRequest", "CopyAssetRequest", "DeleteBlobRequest", "GetBlobRequest", "ImageEmbeddingJobRequest", "ImageResourceTrainingJobRequest", "ImageTransformJobRequest", "MediaTaggingJobRequest", "PinBlobRequest", "PrepareModelJobRequest", "RebootWorkerJobRequest", "TextToImageJobRequest", "UnpinBlobRequest", "UploadBlobRequest", "WDTaggingJobRequest" }

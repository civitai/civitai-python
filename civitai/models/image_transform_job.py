...
class ImageTransformJob(BaseModel):
    ...
    ImageTransformJob
    """ # noqa: E501
    image_url: Optional[StrictStr] = Field(default=None, description="The url of the image to transform", alias="imageUrl")
    transformer: Optional[ImageTransformer] = None
    destination_blob_key: Optional[StrictStr] = Field(default=None, description="Get the key of the destination blob to upload the result to", alias="destinationBlobKey")
    params: Optional[Dict[str, Any]] = Field(default=None, description="A untyped set of parameters that are associated with this job")
    destination_url: Optional[StrictStr] = Field(default=None, description="Get or set the URL where the transformed image will be uploaded to", alias="destinationUrl")
    cost: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Get cost associated with this job")

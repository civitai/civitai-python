...
class ImageTransformJob(BaseModel):
    ...
    destination_blob_key: Optional[StrictStr] = Field(
        default=None, description="Get the key of the destination blob to upload the result to", alias="destinationBlobKey")

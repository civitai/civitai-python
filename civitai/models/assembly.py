...
class Assembly(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["definedTypes", "exportedTypes", "entryPoint", "fullName", "imageRuntimeVersion", "isDynamic", "location", "reflectionOnly", "isCollectible", "isFullyTrusted", "customAttributes", "manifestModule", "modules", "hostContext", "securityRuleSet"]

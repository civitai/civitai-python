...
class ImageEmbeddingJobRequest(JobRequest):
    """
    ImageEmbeddingJobRequest
    """ # noqa: E501
    image_url: Optional[StrictStr] = Field(default=None, description="The url of the image to get embeddings for", alias="imageUrl")

...
from civitai_py.models.module import Module
    ...
    return_type_custom_attributes: Optional[Dict[str, Any]] = Field(
        default=None, alias="returnTypeCustomAttributes")
    __properties: ClassVar[List[str]] = ["name", "declaringType", "reflectedType", "module", "customAttributes", "isCollectible", "metadataToken", "attributes", "methodImplementationFlags", "callingConvention", "isAbstract", "isConstructor", "isFinal", "isHideBySig", "isSpecialName", "isStatic", "isVirtual", "isAssembly", "isFamily",
                                         "isFamilyAndAssembly", "isFamilyOrAssembly", "isPrivate", "isPublic", "isConstructedGenericMethod", "isGenericMethod", "isGenericMethodDefinition", "containsGenericParameters", "methodHandle", "isSecurityCritical", "isSecuritySafeCritical", "isSecurityTransparent", "memberType", "returnParameter", "returnType", "returnTypeCustomAttributes"]

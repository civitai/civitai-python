...
class UploadBlobRequest(JobRequest):
    ...
    key: Optional[StrictStr] = Field(
        default=None, description="Get or set the key of the blob to upload. If no key is specified then a new unique key will be generated")
    replace: Optional[StrictBool] = Field(
        default=None, description="Get or set if existing blobs should be replaced")

...
class TextToImageJobRequest(JobRequest):
    ...
    """  # noqa: E501
    quantity: Optional[Annotated[int, Field(le=100, strict=True, ge=1)]] = Field(
        default=None, description="Get or sets the number of images to generate")
    model: Optional[StrictStr] = Field(
        default=None, description="The AIR of the checkpoint model to use for generation")
    additional_networks: Optional[Dict[str, ImageJobNetworkParams]] = Field(
        default=None, description="Get or set a associative list of additional networks. Use the AIR of the network as the key.", alias="additionalNetworks")
    control_nets: Optional[List[ImageJobControlNet]] = Field(
        default=None, description="Get or set a associative list of additional networks.", alias="controlNets")

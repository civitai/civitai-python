...
class ImageResourceTrainingJob(BaseModel):
    ...
    training_data: Optional[StrictStr] = Field(
        default=None, description="A url referring data that needs to be trained upon", alias="trainingData")
    ...
    cost: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="Get cost associated with this job")
    custom_cost: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="Get or set a custom cost value for this job", alias="customCost")
    output: Optional[StrictStr] = Field(
        default=None, description="An application provided output of the current status of this job")

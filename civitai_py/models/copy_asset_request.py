...
class CopyAssetRequest(JobRequest):
    ...
    job_id: Optional[StrictStr] = Field(
        default=None, description="The ID of the original job to copy", alias="jobId")
    asset_name: Optional[StrictStr] = Field(
        default=None, description="The name of the asset to copy", alias="assetName")
    destination_uri: Optional[StrictStr] = Field(
        default=None, description="The destination URI to copy the asset to", alias="destinationUri")

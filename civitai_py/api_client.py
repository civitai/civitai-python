...
from civitai_py.api_response import ApiResponse, T as ApiResponseT
import civitai_py.models
from civitai_py import rest
from civitai_py.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(civitai_py.models, klass)
